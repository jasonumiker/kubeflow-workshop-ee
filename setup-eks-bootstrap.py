...
#            template_url="https://aws-quickstart.s3.amazonaws.com/quickstart-cloud9-ide/templates/cloud9-ide-instance.yaml",
            template_url="https://ee-assets-prod-us-east-1.s3.amazonaws.com/modules/2cae1f20008d4fc5aaef294602649b98/v9/cloud9-ide-instance.template.yaml",
            parameters={"C9InstanceType":"m5.large","C9Subnet":eks_vpc.public_subnets[0].subnet_id,
                ...
                "BootstrapScriptS3Uri":"s3://ee-assets-prod-us-east-1/modules/2cae1f20008d4fc5aaef294602649b98/v9/bootstrap.sh",
                "QSS3BucketName":"ee-assets-prod-us-east-1","QSS3KeyPrefix":"modules/2cae1f20008d4fc5aaef294602649b98/v9/"
                }
        )
